...
- Web Crawler and Data Parsing – **Get web database from previous web crawler project, reads and filters network circuit data from CSV files**.<br>
- Edge and Node Highlighting – Highlights paths and nodes dynamically based on selection.<br><br>
- ***This repository is for demonstration purposes only. Certain features, such as circuit analysis and alternative pathfinding strategies, have been omitted from this public build.***<br>
...
- Web Crawler - Used legacy web crawler project data to form CSV files, use [BeautifulSoup4](https://pypi.org/project/beautifulsoup4/) and [Request](https://pypi.org/project/requests/) libraries.
- [pandas](https://pandas.pydata.org/) - Used for reading, filtering, and processing CSV data.
